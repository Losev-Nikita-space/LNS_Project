...
_____Установите обязательные зависимости для всего проекта:_____

pip install pyyaml pyserial python-telegram-bot

_____Или одной командой из requirements.txt:_____
...
-------------------------------------------------------------------------
```
## **7. Telegram Bot для мониторинга**
